...
code("N1", "登录页视觉改版", 0, ms(-1,20,10), 2, "定义", None, None, "")
code("N2", "支付流程重构", 0, ms(-1,20,10), 3, "完成", 10, ms(0,11,52), "N2完成，N3变更：改为只做红点提醒")
code("N3", "消息中心优化", 0, ms(-1,20,10), 3, "变更", 10, ms(0,11,52), "N2完成，N3变更：改为只做红点提醒")
code("T1", "先做 N1 的页面骨架", 1, ms(-1,21,3), 3, "完成", 5, ms(0,10,24), "T1 完成，接下去执行T2")
code("T2", "打通 N2 的退款接口", 1, ms(-1,21,3), 3, "进行中", 5, ms(0,10,24), "T1 完成，接下去执行T2")
code("REQ-AUTH-3", "第三方账号绑定", 2, ms(-1,18,40), 2, "进行中", 2, ms(-1,18,40), "调研 OAuth 供应商对比")
